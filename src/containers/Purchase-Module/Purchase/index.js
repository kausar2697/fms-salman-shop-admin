        ...
        <Row>
          ...
          <Col md={8}>
            ...
            <Card style={{ padding: "0px 20px 20px 20px" }}>
              <h4 className="purchase-panel-heading">Purchase Panel</h4>
              <Row>
                <Col md={8}>
                  ...
                  <div className="purchase-box-calculation">
                    <input
                      type="text"
                      class="form-control"
                      aria-label="Sizing example input"
          ...
          <Col md={4}>
            <Card>
              <h4 className="sale-details-heading">Purchase Details Panel</h4>

              <div className="input-group mb-3 purchase-details-input">
